...
class LoggingSettings(pydantic_settings.BaseSettings):
    ...
    log_level_handlers: str = pydantic.Field("DEBUG", alias="LOG_LEVEL_HANDLERS")
    log_level_loggers: str = pydantic.Field("INFO", alias="LOG_LEVEL_LOGGERS")
    log_level_root: str = pydantic.Field("INFO", alias="LOG_LEVEL_ROOT")
